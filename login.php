...
<body>
    ...
    <section class="cover-user bg-white">
        <div class="container-fluid px-0">
            <div class="row g-0 position-relative" style="background:#ffffff;">
                <div class="col-12 cover-my-30 order-2">
                    <div class="cover-user-img d-flex align-items-center justify-content-center" style="background:#ffffff;">
                ...
                <div class="padding-less img order-1" style="display:none !important;"></div><!-- end col -->
            </div>
            <!--end row-->
        </div>
        <!--end container fluid-->
