...
<head>
    ...
    <style> 
        ...
        /* Make sign-up fully responsive - no clipping */
        .cover-user { overflow-y: auto !important; }
        .cover-user .cover-user-img {
            height: auto !important;
            min-height: 100vh;
            align-items: flex-start !important;
        }
        .cover-user .cover-my-30 { overflow: visible !important; }
        @media (max-width: 768px) {
            .cover-user .cover-user-img { min-height: unset; padding: 20px 10px; }
        }
    ...
    <section class="cover-user bg-white">
        <div class="container-fluid px-0">
            <div class="row g-0 position-relative justify-content-center">
                <div class="col-lg-6 col-md-8 col-12 cover-my-30 order-2">
                    <div class="cover-user-img d-flex align-items-start justify-content-center" style="height:auto !important; min-height:100vh; padding: 30px 15px;">
                        <div class="row">
                ...
                <div class="col-lg-7 offset-lg-5 padding-less img order-1" style="display:none !important;">
