                                    ...
                                    <div class="col-lg-12 mx-auto">
                                        ...
                                        <div class="tab-content bg-white">
                                            ...
                                            <?php if ($active_momo->is_active == 1) { ?>
                                                    ...
                                                    <form style="padding: 40px" class="form-horizontal" method="post" id="add_charges_momo" name="add_charges_momo">
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-3">
                                                                ...
                                                                <input class="custom-file-input" id="filesMultiple_momo" name="filesMultiple" type="file" style="display: none;" onchange="cdp_validateZiseFiles();" />
                                                ...
                                                </div> <!-- END MOMO TAB-PANE -->
                                            <?php } ?>

                                            <?php if ($active_airtel->is_active == 1) { ?>
                                                <!-- AIRTEL MONEY TAB-PANE -->
                                                <div id="airtel" class="tab-pane fade pt-3">
                                                    <form style="padding: 40px" class="form-horizontal" method="post" id="add_charges_airtel" name="add_charges_airtel">
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-3">
                                                                <label class="control-label"><?php echo $lang['leftorder15']; ?></label>
                                                                <input class="custom-file-input" id="filesMultiple_airtel" name="filesMultiple" type="file" style="display: none;" onchange="cdp_validateZiseFiles();" />
