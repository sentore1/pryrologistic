...
$('#clean_file_button_momo').on('click', function () {
  $("#filesMultiple_momo").val('');
  $('#clean_files_momo').addClass('hide');
});
$('#filesMultiple_momo').on('change', function () {
  var count = this.files.length;
  if (count > 0) { $('#clean_files_momo').removeClass('hide'); }
  else { $('#clean_files_momo').addClass('hide'); }
});
...
$('#clean_file_button_airtel').on('click', function () {
  $("#filesMultiple_airtel").val('');
  $('#clean_files_airtel').addClass('hide');
});
$('#filesMultiple_airtel').on('change', function () {
  var count = this.files.length;
  if (count > 0) { $('#clean_files_airtel').removeClass('hide'); }
  else { $('#clean_files_airtel').addClass('hide'); }
});